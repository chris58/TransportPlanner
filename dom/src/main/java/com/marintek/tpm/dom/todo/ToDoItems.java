...
import com.marintek.tpm.dom.todo.ToDoItem.Category;
...
public class ToDoItems extends AbstractFactoryAndRepository {
    ...
    @Hidden
    public List<ToDoItem> inCategory(final Category cat) {
        return allMatches(ToDoItem.class, new Filter<ToDoItem>() {
            @Override
            public boolean accept(ToDoItem t) {
                return Objects.equal(cat, t.getCategory()) && ownedByCurrentUser(t);
            }
        });
    }
